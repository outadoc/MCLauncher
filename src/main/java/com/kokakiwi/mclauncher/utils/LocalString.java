...
public class LocalString {
	...
	private Map<String, Map<String, Object>> strings = new HashMap<String, Map<String, Object>>();
	private String lang;
	...
	public LocalString(LauncherFrame launcherFrame, List<String> langs)
	{
		...
		{
			strings.put(lang, load(Utils.getResourceAsStream("lang/" + lang + ".yml")));
		}
	...
	public String getString(String node)
	{
		...
		params.put("GAMENAME", launcherFrame.config.getString("gameLauncher.gameName"));
